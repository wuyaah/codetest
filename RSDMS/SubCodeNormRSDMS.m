...
for iter=1:numel(degreeSet)
    ...
    while true
        ...
        while true
            ...
            plaStress=cellfun(@(x,y)subCalElemPlaStress(x,y),stress,elemYield,'UniformOutput',0);
    ...
    tt=toc(tt);
    % result=RSDMSPostProcess(dataPack, selLoadingCoe, alphaSet(end));
